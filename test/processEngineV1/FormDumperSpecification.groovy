...
class FormDumperSpecification extends Specification {
    ...
    def setup() {
        ...
        StartedByUserV1 startedByUser = StartedByUserV1.builder()
                .userId("1")
                .servicekontoType(ServicekontoContextTypeV1.ORGANISATIONSKONTO)
                .displayName("user")
                .primaryName("user")
                .postfachHandle("{\"@type\":\"nkb\",\"id\":\"ab0b63be-ee10-4740-b5e7-66aa81834510\"}")
                .postfach(PostfachV1.builder()
                        .handle("{\"@type\":\"nkb\",\"id\":\"ab0b63be-ee10-4740-b5e7-66aa81834510\"}")
