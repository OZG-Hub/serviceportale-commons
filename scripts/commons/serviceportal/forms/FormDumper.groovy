...
class FormDumper {
  ...
  String dumpFormAsCsv(boolean withMetadata = false) {
    ...
    if (withMetadata) {
      ...
      // Add metadata
      result += "postfachHandleId" + CSV_SEPARATOR + escapeForCsv(metadata.get("postfachHandleId")) + "\r\n"
  ...
  String dumpAsXml(boolean withMetadata = false) {
    ...
    xml."serviceportal"() {
      if (withMetadata) {
        ...
        // Add metadata
        "metadata"() {
          "postfachHandleId"(metadataMap.get("postfachHandleId"))
  ...
  /**
   * Generates a map of metadata with entries for postfachHandle id, form id, creation date
